...
Plots the number of shuttles against the percentage of observations
...
trials with unusually low or high shuttling within the project.
...
- lower_quantile:
  ...
  Lower shuttling quantile used for screening. Default is 0.05.

- upper_quantile:

  Upper shuttling quantile used for screening. Default is 0.95.
